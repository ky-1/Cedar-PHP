...
function hexToHsl($color, $returnAsArray = false)
{
        ...
        <div class="post-list-outline">
            ...
            <form id="account-settings-form" class="setting-form" method="post" action="/settings/account">
                <ul class="settings-list">
                    ...
                    <li>
                        <p class="settings-label"><label>Change your background image.</label></p>
                        <div class="select-content">
                            <div class="select-button">
                                <input name="background" style="float: left;" accept="image/*" type="file">
                                <input type="button" value="reset to default" onclick="$('input[name=\'background\']').remove();" style="
                                border: none;
                                background-color: #efefef;
                                padding: 5px;
                                border-radius: 3px;
                    ...
                    <li>
                        <p class="settings-label">
                            <label for="select_notify.empathy_notice_opt_out">Do you want to receive notifications about Yeahs?</label>
                        </p>
                        <div class="select-content">
                            <div class="select-button">
                ...
                <div class="form-buttons">
                    <input type="submit" class="black-button apply-button" value="Save Settings" data-community-id="" data-url-id="" data-track-label="user" data-title-id="" data-track-action="changeSetting" data-track-category="setting">
                </div>
            </form>
        </div>
    </div>
...
<?php
    ...
    if (!($_POST['yeah_notifs'] == 0 || $_POST['yeah_notifs'] == 1)) {
        $errors[]='stop';
    }
        ...
        if (isset($_FILES['background'])) {
            ...
            if (!empty($img['name'])) {
                ...
                if ($image == 1) {
                    ...
                    setcookie('cedar_background_image', $image, strtotime('+10 days'), '/');
                }
            }
        } else {
            setcookie('cedar_background_image', 'NULL', strtotime('-20 days'), '/');
        }
        echo 'Settings saved.';
    }
}
